...
namespace SimpleTaskSystem.Tests
{
    public abstract class SimpleTaskSystemTestBase : AbpIntegratedTestBase<SimpleTaskSystemTestModule>
    {
        ...
        protected Task UsingDbContextAsync(Func<SimpleTaskSystemDbContext, Task> action)
        {
        ...
        protected Task<T> UsingDbContextAsync<T>(Func<SimpleTaskSystemDbContext, Task<T>> func)
        {
            return UsingDbContextAsync(AbpSession.TenantId, func);
        }

        protected void UsingDbContext(int? tenantId, Action<SimpleTaskSystemDbContext> action)
        {
        ...
        protected async Task UsingDbContextAsync(int? tenantId, Func<SimpleTaskSystemDbContext, Task> action)
        {
            using (UsingTenantId(tenantId))
            {
                using (var context = LocalIocManager.Resolve<SimpleTaskSystemDbContext>())
        ...
        protected T UsingDbContext<T>(int? tenantId, Func<SimpleTaskSystemDbContext, T> func)
        {
            T result;
        ...
        protected async Task<T> UsingDbContextAsync<T>(int? tenantId, Func<SimpleTaskSystemDbContext, Task<T>> func)
        {
            T result;
